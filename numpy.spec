...
Source0:        https://github.com/%{pkg_name}/%{pkg_name}/releases/download/v%{version}/%{pkg_name}-%{version}%{?relc}.tar.gz
...
Obsoletes:      %{?scl_prefix}f2py <= 1:1.10.1-3
...
%files
%doc docs-f2py LICENSE.txt THANKS.txt site.cfg.example
...
%changelog
* Thu Jun 15 2017 Iryna Shcherbina <ishcherb@redhat.com> - 1:1.13.0-1
- Update to 1.13.0
...
* Tue Jan 27 2015 jchaloup <jchaloup@redhat.com> - 1:1.8.2-1
- Update to 0.8.2

* Tue Mar 04 2014 Tomas Tomecek <ttomecek@redhat.com> - 1:1.7.1-9
- numpy should own %{python3_sitearch}/numpy/__pycache__ (rhbz#1072424)

* Tue Feb 11 2014 Tomas Tomecek <ttomecek@redhat.com> - 1:1.7.1-8
- Fix CVE-2014-1858, CVE-2014-1859: #1062009

* Tue Jan 14 2014 Tomas Tomecek <ttomecek@redhat.com> - 1:1.7.1-7
